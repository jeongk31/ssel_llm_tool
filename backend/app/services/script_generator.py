...
"""
Auto-generated by ChAT (Chat Annotation Toolkit).

This standalone script runs the configured single-model coding task. Use ChAT's
...
def main():
    ...
    if args.also_save_episodes:
        print("[WARN] --also-save-episodes applies only to a generated ChAT package.")
