...
Empty-message handling: {empty_message_handling}

Note: this standalone script runs the single model above. To run multiple models
and aggregate their votes, use the app's "Run Coding" instead.

Generated by ChAT (Chat Annotation Toolkit)
"""
...
EMPTY_MESSAGE_HANDLING = {json.dumps(empty_message_handling)}  # "ignore" | "code" | anything else = null + _error
